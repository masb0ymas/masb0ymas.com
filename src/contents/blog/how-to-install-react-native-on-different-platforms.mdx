...
<BadgeList labels={["react-native", "android", "ios", "cli"]} />
<span className="text-sm lg:text-base text-neutral-600 dark:text-neutral-400">{formatLocalDate('2024-09-02', "dd MMMM yyyy")}</span>
