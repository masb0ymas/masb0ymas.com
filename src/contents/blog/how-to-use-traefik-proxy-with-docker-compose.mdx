...
<BadgeList labels={['docker', 'traefik']} />
<span className="text-sm lg:text-base text-neutral-600 dark:text-neutral-400">{formatLocalDate('2024-07-21', "dd MMMM yyyy")}</span>
