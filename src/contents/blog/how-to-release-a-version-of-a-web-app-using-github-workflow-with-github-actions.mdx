...
<BadgeList labels={["github-actions", "docker"]} />
<span className="text-sm lg:text-base text-neutral-600 dark:text-neutral-400">{formatLocalDate('2024-07-14', "dd MMMM yyyy")}</span>
