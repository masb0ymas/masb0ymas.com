...
<BadgeList labels={['web3', 'solidity', 'NFT']} />
<span className="text-sm lg:text-base text-neutral-600 dark:text-neutral-400">{formatLocalDate('2024-08-04', "dd MMMM yyyy")}</span>
