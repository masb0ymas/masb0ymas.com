...
# How do you implement an NFT Smart Contract with Remix and publish it on OpenSea?
<BadgeList labels={["web3", "solidity", "NFT", "remix"]} />
<span className="text-sm lg:text-base text-neutral-600 dark:text-neutral-400">{formatLocalDate('2024-08-10', "dd MMMM yyyy")}</span>
