...
# How to Use GitHub Actions for CI/CD and Push to Google Artifact Registry
<BadgeList labels={["Docker", "CI/CD", "GitHub Actions", "Google Artifact Registry"]} />
<span className="text-sm lg:text-base text-neutral-600 dark:text-neutral-400">{formatLocalDate('2024-11-04', "dd MMMM yyyy")}</span>
